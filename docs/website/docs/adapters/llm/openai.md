...
# OpenAI LLM Adapter for RTP Agent

OpenAI provides access to industry-leading models like GPT-4o and GPT-4 Turbo. These models are highly capable across a wide range of tasks, including reasoning, coding, and creative writing.
...
Below is a basic conceptual example demonstrating how to initialize the OpenAI LLM adapter within an RTP Agent session:
