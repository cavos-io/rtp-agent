...
# Sarvam AI STT Adapter for RTP Agent
...
Below is a basic conceptual example demonstrating how to initialize the Sarvam AI STT adapter within an RTP Agent session:
...
func main() {
	...
	// Initialize the Sarvam AI STT adapter
	sttProvider, err := sarvam.NewProvider(
