...
# Azure STT Adapter for RTP Agent
...
Below is a basic conceptual example demonstrating how to initialize the Azure STT adapter within an RTP Agent session:
...
func main() {
	...
	// Initialize the Azure STT adapter
	sttProvider, err := azure.NewProvider(
