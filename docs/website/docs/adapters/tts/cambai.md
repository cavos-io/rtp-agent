...
# Camb.ai TTS Adapter for RTP Agent

Camb.ai provides advanced AI-powered voice synthesis with a focus on cross-lingual voice cloning and high-fidelity emotional expression.
...
Below is a basic conceptual example demonstrating how to initialize the Camb.ai TTS adapter within an RTP Agent session:
...
func main() {
	...
	// Initialize the Camb.ai TTS adapter
	ttsProvider, err := cambai.NewProvider(
