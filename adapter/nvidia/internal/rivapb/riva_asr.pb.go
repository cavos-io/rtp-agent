...
func (x *StreamingRecognizeRequest) GetRuntimeConfig() map[string]string {
	if x != nil {
...
const file_riva_proto_riva_asr_proto_rawDesc = "" +
	...
	"\x02id\x18d \x01(\v2\x16.nvidia.riva.RequestIdR\x02id\"\x81\x03\n" +
	...
	"\raudio_content\x18\x02 \x01(\fH\x00R\faudioContent\x12d\n" +
	"\x0eruntime_config\x18\x03 \x03(\v2=.nvidia.riva.asr.StreamingRecognizeRequest.RuntimeConfigEntryR\rruntimeConfig\x12&\n" +
	"\x02id\x18d \x01(\v2\x16.nvidia.riva.RequestIdR\x02id\x1a@\n" +
	...
	"\x1eGetRivaSpeechRecognitionConfig\x123.nvidia.riva.asr.RivaSpeechRecognitionConfigRequest\x1a4.nvidia.riva.asr.RivaSpeechRecognitionConfigResponse\"\x00B\x1bZ\x16nvidia.com/riva_speech\xf8\x01\x01b\x06proto3"
...
var file_riva_proto_riva_asr_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_riva_proto_riva_asr_proto_goTypes = []any{
	...
	nil,                // 18: nvidia.riva.asr.StreamingRecognizeRequest.RuntimeConfigEntry
	nil,                // 19: nvidia.riva.asr.RecognitionConfig.CustomConfigurationEntry
	(*RequestId)(nil),  // 20: nvidia.riva.RequestId
	(AudioEncoding)(0), // 21: nvidia.riva.AudioEncoding
}
var file_riva_proto_riva_asr_proto_depIdxs = []int32{
	...
	20, // 2: nvidia.riva.asr.RecognizeRequest.id:type_name -> nvidia.riva.RequestId
	6,  // 3: nvidia.riva.asr.StreamingRecognizeRequest.streaming_config:type_name -> nvidia.riva.asr.StreamingRecognitionConfig
	18, // 4: nvidia.riva.asr.StreamingRecognizeRequest.runtime_config:type_name -> nvidia.riva.asr.StreamingRecognizeRequest.RuntimeConfigEntry
	20, // 5: nvidia.riva.asr.StreamingRecognizeRequest.id:type_name -> nvidia.riva.RequestId
	21, // 6: nvidia.riva.asr.RecognitionConfig.encoding:type_name -> nvidia.riva.AudioEncoding
	8,  // 7: nvidia.riva.asr.RecognitionConfig.speech_contexts:type_name -> nvidia.riva.asr.SpeechContext
	7,  // 8: nvidia.riva.asr.RecognitionConfig.diarization_config:type_name -> nvidia.riva.asr.SpeakerDiarizationConfig
	19, // 9: nvidia.riva.asr.RecognitionConfig.custom_configuration:type_name -> nvidia.riva.asr.RecognitionConfig.CustomConfigurationEntry
	4,  // 10: nvidia.riva.asr.RecognitionConfig.endpointing_config:type_name -> nvidia.riva.asr.EndpointingConfig
	5,  // 11: nvidia.riva.asr.StreamingRecognitionConfig.config:type_name -> nvidia.riva.asr.RecognitionConfig
	10, // 12: nvidia.riva.asr.RecognizeResponse.results:type_name -> nvidia.riva.asr.SpeechRecognitionResult
	20, // 13: nvidia.riva.asr.RecognizeResponse.id:type_name -> nvidia.riva.RequestId
	11, // 14: nvidia.riva.asr.SpeechRecognitionResult.alternatives:type_name -> nvidia.riva.asr.SpeechRecognitionAlternative
	12, // 15: nvidia.riva.asr.SpeechRecognitionAlternative.words:type_name -> nvidia.riva.asr.WordInfo
	15, // 16: nvidia.riva.asr.StreamingRecognizeResponse.results:type_name -> nvidia.riva.asr.StreamingRecognitionResult
	20, // 17: nvidia.riva.asr.StreamingRecognizeResponse.id:type_name -> nvidia.riva.RequestId
	11, // 18: nvidia.riva.asr.StreamingRecognitionResult.alternatives:type_name -> nvidia.riva.asr.SpeechRecognitionAlternative
	14, // 19: nvidia.riva.asr.StreamingRecognitionResult.pipeline_states:type_name -> nvidia.riva.asr.PipelineStates
	17, // 20: nvidia.riva.asr.RivaSpeechRecognitionConfigResponse.Config.parameters:type_name -> nvidia.riva.asr.RivaSpeechRecognitionConfigResponse.Config.ParametersEntry
	2,  // 21: nvidia.riva.asr.RivaSpeechRecognition.Recognize:input_type -> nvidia.riva.asr.RecognizeRequest
	3,  // 22: nvidia.riva.asr.RivaSpeechRecognition.StreamingRecognize:input_type -> nvidia.riva.asr.StreamingRecognizeRequest
	0,  // 23: nvidia.riva.asr.RivaSpeechRecognition.GetRivaSpeechRecognitionConfig:input_type -> nvidia.riva.asr.RivaSpeechRecognitionConfigRequest
	9,  // 24: nvidia.riva.asr.RivaSpeechRecognition.Recognize:output_type -> nvidia.riva.asr.RecognizeResponse
	13, // 25: nvidia.riva.asr.RivaSpeechRecognition.StreamingRecognize:output_type -> nvidia.riva.asr.StreamingRecognizeResponse
	1,  // 26: nvidia.riva.asr.RivaSpeechRecognition.GetRivaSpeechRecognitionConfig:output_type -> nvidia.riva.asr.RivaSpeechRecognitionConfigResponse
