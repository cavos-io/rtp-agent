...
func nvidiaTTSTailStartsSentence(tail string) bool {
	...
	for _, starter := range []string{"I", "You", "Can", "Do", "Is", "Are", "No", "Not", "If", "As", "For", "On", "In", "At", "To", "Why", "When", "Where", "Also", "Then", "Let", "He", "She", "It", "They", "Their", "Our", "We", "But", "However", "That", "This", "Next", "Please", "Should", "Now", "Today", "After", "Before", "Because", "Since", "While", "Once", "Maybe", "Yes", "Sure", "Alright", "Absolutely", "Got it", "Okay", "Right", "Great", "Perfect", "Excellent", "Fine", "Sounds good", "Sounds great", "Sounds fine", "First", "Second", "Finally", "Take", "Go", "And", "Or", "Yet", "Still", "Instead", "Meanwhile", "Later", "Soon", "There", "Here", "These", "Those", "Another", "Any", "Some", "All", "Each", "Every", "Most", "Many", "Much", "Several", "Both", "Neither", "One", "Two", "Three", "Last", "Previous", "New", "Only", "Other", "More", "Will", "Have", "Had", "Did", "Does", "A", "The", "My", "Your", "His", "Her", "Its", "What", "Who", "Which", "How", "About", "Over", "Under", "Through", "From", "By", "With", "Without", "During", "Until", "Though", "Although", "Whenever", "Whatever", "Whether"} {
