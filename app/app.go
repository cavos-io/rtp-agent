...
func (a *App) startAudioRecorder(ctx *worker.JobContext, roomIO *workerlivekit.RoomIO) error {
	...
	return roomIO.Recorder.Start(filepath.Join(ctx.SessionDirectory(), workerlivekit.RecordingFileName), workerlivekit.RecordingSampleRate)
}
