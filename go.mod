...
require (
	...
	github.com/AgoraIO-Extensions/Agora-Golang-Server-SDK/v2 v2.6.4
...
require (
	...
	github.com/cavos-io/go-file-arch v0.0.4 // indirect
...
tool (
	github.com/cavos-io/go-file-arch/cmd/go-file-arch
